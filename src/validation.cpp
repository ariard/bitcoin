...
public:
    ...
    /**
    * Update with coins spent and created by a transaction. All inputs should exist and not already
    * be spent. Only used for package validation.
    */
...
PackageMempoolAcceptResult MemPoolAccept::AcceptMultipleTransactions(const std::vector<CTransactionRef>& txns, ATMPArgs& args)
{
    ...
    std::vector<CTxMemPoolEntry> _entries;
    ...
    if (!m_pool.CalculateMemPoolAncestors(_entries, _ancestors, m_limit_ancestors,
