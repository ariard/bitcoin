...
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_xonly_pubkey_add(
    const secp256k1_context* ctx,
    secp256k1_xonly_pubkey *internal_pubkey,
    const secp256k1_xonly_pubkey *point
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);

SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_xonly_pubkey_negate(
        const secp256k1_context* ctx,
        secp256k1_xonly_pubkey *pubkey
