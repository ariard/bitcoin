...
void CConnman::OpenNetworkConnection(const CAddress& addrConnect, bool fCountFailure, CSemaphoreGrant *grantOutbound, const char *pszDest, bool fAddrFetch, bool fFeeler, bool manual_connection, bool block_relay_only)
{
    //
